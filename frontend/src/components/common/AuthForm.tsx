...
type AuthFormProps = {
  /** Called once a real session exists — never on a failed attempt. */
  onSuccess: () => void;
};
...
/**
 * The sign-in / sign-up form on its own, without any surrounding chrome.
 *
 * Shared by the navbar modal and the checkout login step so there is exactly
 * one place that talks to the auth API — two copies of this would be two places
 * to get session handling wrong.
 */

 ...
 * are the site's existing gray-900 on white.
 *
...
function BrandLoader({ label = "Loading" }: BrandLoaderProps) {
  return (
    <div
      ...
      aria-busy
      className="fixed inset-0 z-[100] flex flex-col items-center justify-center gap-6 bg-white px-6"
    >
      ...
      <span className="relative flex items-center justify-center">
        <span
          aria-hidden
          className="absolute h-16 w-16 rounded-3xl bg-gray-900 animate-[brand-halo_2.4s_ease-in-out_infinite] motion-reduce:hidden sm:h-20 sm:w-20"
        />

        <span className="relative flex h-16 w-16 items-center justify-center overflow-hidden rounded-2xl bg-gray-900 text-3xl font-black text-white shadow-lg animate-[brand-breathe_2.4s_ease-in-out_infinite] motion-reduce:animate-none sm:h-20 sm:w-20 sm:text-4xl">
          B
          <span
            aria-hidden
      ...
      <span className="relative block h-1 w-32 overflow-hidden rounded-full bg-gray-200">
        <span
          aria-hidden
          className="absolute inset-y-0 left-0 w-1/3 rounded-full bg-gray-900/70 animate-[route-progress_1.1s_ease-in-out_infinite] motion-reduce:hidden"
        />
      </span>

      ...
      <Container className="py-16" narrow="sm">
        <div className="rounded-2xl border border-taupe bg-gradient-to-br from-cyan-50 to-mint-50 p-7 text-center">
          ...
          <Link
            to="/login"
            state={{ from }}
            className="mt-6 flex w-full items-center justify-center gap-2 rounded-full bg-gradient-to-r from-[#00c9ff] to-[#92fe9d] py-3 text-sm font-bold text-charcoal-900 transition hover:shadow-md hover:shadow-cyan-500/30 hover:brightness-105"
          >
            <FiLogIn size={15} />
            Log in
          </Link>
